# os-maps-example documentation build configuration file
#
...
htmlhelp_basename = "os-maps-exampledoc"
...
latex_documents = [
    ("index",
     "os-maps-example.tex",
     u"os-maps-example Documentation",
     u"Henry Cooksley", "manual"),
]
...
man_pages = [
    ("index", "os-maps-example", u"os-maps-example Documentation",
     [u"Henry Cooksley"], 1)
]
...
texinfo_documents = [
    ("index", "os-maps-example", u"os-maps-example Documentation",
     u"Henry Cooksley", "os-maps-example",
     "OS Maps Example in Python", "Miscellaneous"),
]
